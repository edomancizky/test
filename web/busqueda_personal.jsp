...
<html>
    ...
    <script>
        function retornar(id, nom, ape) {
            if (!window.opener.closed) {
                window.opener.document.forms[0].id_personal.value = id;
                window.opener.document.forms[0].nombre.value = nom;
                window.opener.document.forms[0].apellido.value = ape;
                window.opener.focus();
                window.close();
            }
        }
    ...
    <center>
        <h1><p style="color:black";> Busqueda Personal  </p></h1><br>
        ...
        <table border="1" width="50%" id="myTable" style="color: black">
            ...
            <%
                ...
                try {
                    bd.listar_datos("select * from personal");
                    while (bd.resultado.next()) {
                        ...
                        out.println("<td>");
                        out.println("<a href=\"javascript:retornar(" + bd.resultado.getString("id_personal") + ",'" + bd.resultado.getString("nombre")+"','" + bd.resultado.getString("apellido")+ "');\"> "
